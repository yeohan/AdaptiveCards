...
- (id)initWithCpp:(const std::shared_ptr<::djinni::DjinniAdaptiveCard>&)cppRef;

@end

@implementation ACDjinniAdaptiveCard {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::djinni::DjinniAdaptiveCard>> _cppRefHandle;
}
