...
- (id)initWithCpp:(const std::shared_ptr<::djinni::DjinniTextBlock>&)cppRef;

@end

@implementation ACDjinniTextBlock {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::djinni::DjinniTextBlock>> _cppRefHandle;
}
...
- (void)SetTextColor:(ACDjinniTextColor)textColor {
    try {
        _cppRefHandle.get()->SetTextColor(::djinni::Enum<::djinni::DjinniTextColor, ACDjinniTextColor>::toCpp(textColor));
    } DJINNI_TRANSLATE_EXCEPTIONS()
}
...
- (ACDjinniTextColor)GetTextColor {
    try {
        ...
        return ::djinni::Enum<::djinni::DjinniTextColor, ACDjinniTextColor>::fromCpp(objcpp_result_);
    } DJINNI_TRANSLATE_EXCEPTIONS()
}
